...
const config = {
  proxyListPath, proxyListDefaultProtocol, logLevel, errorTraces,
  maxConcurrency, reqBatchDelayMS, reqTimeoutMS, reqBatchSize, reqDelayMS,
  latencyRatingAMS, latencyRatingBMS, latencyRatingCMS, latencyRatingDMS,
  serverProxyListPath, serverHost, serverPort, telegramBotToken,
  dbJSONStorePath, rootPath
}

module.expotrs = config
